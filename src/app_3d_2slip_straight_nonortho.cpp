...
#include "string.h"
#include "stdlib.h"
#include "app_3d_2slip_straight_nonortho.h"
#include "fft.h"
#include "solve.h"
...
App3D2SStNONORTHO::App3D2SStNONORTHO(PFDD_C *pfdd_p, int narg, char **arg) :
  App(pfdd_p,narg,arg)
{
  ndouble = 0;
  timestep = 1.0;
...
App3D2SStNONORTHO::~App3D2SStNONORTHO()
{
  delete [] sites;
}
...
void App3D2SStNONORTHO::grow_app()
{
  darray = fft->xi;
}
...
void App3D2SStNONORTHO::init_app()
{
  delete [] sites;
...
/* ----------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
void App3D2SStNONORTHO::input_app(char *command, int narg, char **arg)
{
...
void App3D2SStNONORTHO::set_slip()
{
  int i, j, k;
  double s3;
...
double App3D2SStNONORTHO::compute_mean_xi(int n, int flag)
{
  int lN1 = fft->local_x;
...
double App3D2SStNONORTHO::compute_stress(int n, int flag)
{
  int lN1 = fft->local_x;
  int lxs = fft->local_x_start;
  int N2 = fft->local_y;
...
double App3D2SStNONORTHO::compute_strain(int n, int flag)
{
  int lN1 = fft->local_x;
  int lxs = fft->local_x_start;
  int N2 = fft->local_y;
...
void App3D2SStNONORTHO::stats(char *strtmp)
{
  char *strpnt = strtmp;
...
void App3D2SStNONORTHO::stats_header(char *strtmp)
{
  char *strpnt = strtmp;
