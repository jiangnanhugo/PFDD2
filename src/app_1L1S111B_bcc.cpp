...
App1L1S111Bbcc::App1L1S111Bbcc(PFDD_C *pfdd_p, int narg, char **arg) :
  App(pfdd_p,narg,arg)
{
  ndouble = 0;
  timestep = 1.0;
  ...
  if(setup_flag == -1)
    setup_flag = 8; //default to 1L ortho cc
  if(core_flag == -1)
...
/* ----------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
void App1L1S111Bbcc::input_app(char *command, int narg, char **arg)
{
...
double App1L1S111Bbcc::compute_mean_xi(int n, int flag)
{
  int lN1 = fft->local_x;
...
double App1L1S111Bbcc::compute_theta(int n, int flag)
{
  int lN1 = fft->local_x;
  int lxs = fft->local_x_start;
  int N2 = fft->local_y;
...
double App1L1S111Bbcc::compute_stress(int n, int flag)
{
  int lN1 = fft->local_x;
  int lxs = fft->local_x_start;
  int N2 = fft->local_y;
...
double App1L1S111Bbcc::compute_strain(int n, int flag)
{
  int lN1 = fft->local_x;
  int lxs = fft->local_x_start;
  int N2 = fft->local_y;
...
void App1L1S111Bbcc::stats(char *strtmp)
{
  char *strpnt = strtmp;
...
void App1L1S111Bbcc::stats_header(char *strtmp)
{
  char *strpnt = strtmp;
